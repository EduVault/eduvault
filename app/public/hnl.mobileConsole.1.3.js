...
var mobileConsole = (function() {
  ...
  var options = {
    ...
    originalConsole = {
      ...
      info:
        console && typeof console.info === 'function' ? console.info.bind(console) : missingMethod,
      ...
      groupEnd:
        console && typeof console.groupEnd === 'function'
          ...
          : missingMethod,
      warn:
        console && typeof console.warn === 'function' ? console.warn.bind(console) : missingMethod,
      error:
  ...
  function initConsoleElement() {
    ...
    function attach(console) {
      ...
      setCSS(document.body, {
        paddingBottom:
          existingPadding + Math.abs(console.offsetHeight + elements.topbar.offsetHeight) + 'px',
      });
      elements.scrollcontainer.scrollTop = elements.scrollcontainer.scrollHeight;
    ...
    function newConsole() {
      try {
        ...
        var method = arguments[0],
          ...
          isHTMLElement,
          message =
            typeof arguments[1].newMessage !== 'undefined' ? arguments[1].newMessage : undefined,
          stackTrace =
        ...
        originalConsole.error(
          'mobileConsole generated an error logging this event! (type: ' + typeof message + ')'
        );
